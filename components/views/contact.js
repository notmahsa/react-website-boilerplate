        ...
        <div className="row">
          ...
          <div className="col-sm-6">
            <div className={`form-group ${formValidation.name ? 'has-error' : ''}`}>
              ...
              <input type="text" value={form.name} onChange={handleChange} placeholder="Ener your full name" name="name"
                     className="form-control"/>
            </div>
            <div className={`form-group ${formValidation.email ? 'has-error' : ''}`}>
              <label htmlFor="email">Email</label>
              <input type="email" value={form.email} onChange={handleChange} placeholder="Enter your email address"
                     name="email" className="form-control"/>
            </div>
            <div className="form-group">
              <label htmlFor="phone">Phone (Optional)</label>
              <input type="text" value={form.phone} onChange={handleChange} placeholder="Enter your phone number"
            ...
            <div className={`form-group ${formValidation.message ? 'has-error' : ''}`}>
              ...
              <textarea name="message" value={form.message} onChange={handleChange} className="form-control"
                        placeholder="Enter a message" id="" cols="10" rows="5"></textarea>
            </div>
            {
